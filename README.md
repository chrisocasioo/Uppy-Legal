...
Public pages for Uppy — support, privacy policy, and marketing — published as a static site via GitHub Pages. No backend, no build step, no framework.
...
- [ ] Swap the "Coming soon" App Store badge links in `index.html` for the real `apps.apple.com` listing URL once Uppy is live.
